(function (ng) {
    ...
    ng.module("rc.directives").directive("rcCropperTmdb", ["$modal", "rcWebservice", rcCropperTmdb]);
    ...
    function rcCropperTmdb($modal, rcWebservice) {
    ...
    function cropperTmdbController($scope, $modalInstance, rcWebservice, webservice, info, options, broadcastId, data) {
