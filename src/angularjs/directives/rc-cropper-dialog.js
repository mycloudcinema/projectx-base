(function (ng) {
	...
	ng.module("rc.directives")
		.directive("rcCropperDialog", ["$modal", "rcWebservice", rcCropperDialog]);
	...
	function rcCropperDialog($modal, rcWebservice) {
	...
	function cropperDialogController($scope, $modalInstance, rcWebservice, webservice, info, options, broadcastId) {
