...
(function (ng) {
	...
	ng.module("rc.directives")
		.directive("rcImageSelect", ["$modal", "MediaManager", rcImageSelect]);
	...
	function rcImageSelect($modal, MediaManager) {
	...
	function imageSelectDialogController($scope, $modalInstance, mediaManager, options, broadcastId) {
