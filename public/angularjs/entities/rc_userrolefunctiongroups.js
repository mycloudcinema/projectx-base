...
(function (ng) {
	...
	ng.module("rc.entities")
		.factory("UserRoleFunctionGroups", ["rcDateHandler", UserRoleFunctionGroupsFactory])
		.factory("UserRoleFunctionGroupsManager", ["EntityManager", "UserRoleFunctionGroups", UserRoleFunctionGroupsManagerFactory]);

	function UserRoleFunctionGroupsFactory(rcDateHandler) {
		...
		function UserRoleFunctionGroups(data) {
			...
			setAuditValues(this, data, rcDateHandler, 'user_role_function_groups_id');
