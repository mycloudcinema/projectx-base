...
(function (ng) {
	...
	ng.module("rc.entities")
		.factory("FunctionGroups", ["rcDateHandler", FunctionGroupsFactory])
		.factory("FunctionGroupsManager", ["EntityManager", "FunctionGroups", FunctionGroupsManagerFactory]);

	function FunctionGroupsFactory(rcDateHandler) {
		...
		function FunctionGroups(data) {
			...
			setAuditValues(this, data, rcDateHandler, 'function_group_id');
