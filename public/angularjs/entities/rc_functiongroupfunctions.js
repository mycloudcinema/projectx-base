...
(function (ng) {
	...
	ng.module("rc.entities")
		.factory("FunctionGroupFunctions", ["rcDateHandler", FunctionGroupFunctionsFactory])
	...
	function FunctionGroupFunctionsFactory(rcDateHandler) {
		...
		function FunctionGroupFunctions(data) {
			...
			setAuditValues(this, data, rcDateHandler, 'function_group_functions_id');
